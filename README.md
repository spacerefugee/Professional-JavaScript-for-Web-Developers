...
- [10.1 节点层次](/chapter%2010#101-节点层次)
  - [10.1.1 Node类型](/chapter%2010#1011-Node类型)
    - [1. nodeName和nodeValue属性](/chapter%2010#1-nodeName和nodeValue属性)
    - [2. 节点关系](/chapter%2010#2-节点关系)
    - [3. 操作节点](/chapter%2010#3-操作节点)
    - [4. 其他方法](/chapter%2010#4-其他方法)
  - [10.1.2 Document类型](/chapter%2010#1012-Document类型)
    - [1. 文档的子节点](/chapter%2010#1-文档的子节点)
    - [2. 文档信息](/chapter%2010#2-文档信息)
    - [3. 查找元素](/chapter%2010#3-查找元素)
    - [4. 特殊集合](/chapter%2010#4-特殊集合)
    - [5. DOM一致性检测](/chapter%2010#5-DOM一致性检测)
    - [6. 文档写入](/chapter%2010#6-文档写入)
  - [10.1.3 Element类型](/chapter%2010#1013-Element类型)
    - [1. HTML元素](/chapter%2010#1-HTML元素)
    - [2. 取得特性](/chapter%2010#2-取得特性)
    - [3. 设置特性](/chapter%2010#3-设置特性)
    - [4. attributes属性](/chapter%2010#4-attributes属性)
    - [5. 创建元素](/chapter%2010#5-创建元素)
    - [6. 元素的子节点](/chapter%2010#6-元素的子节点)
  - [10.1.4 Text类型](/chapter%2010#1014-Text类型)
    - [1. 创建文本节点](/chapter%2010#1-创建文本节点)
    - [2. 规范化文本节点](/chapter%2010#2-规范化文本节点)
  - [10.1.5 Comment类型](/chapter%2010#1015-Comment类型)
  - [10.1.6 CDATASection类型](/chapter%2010#1016-CDATASection类型)
  - [10.1.7 DocumentType类型](/chapter%2010#1017-DocumentType类型)
  - [10.1.8 DocumentFragment类型](/chapter%2010#1018-DocumentFragment类型)
  - [10.1.9 Attr类型](/chapter%2010#1019-Attr类型)
- [10.2 DOM操作技术](/chapter%2010#102-DOM操作技术)
  - [10.2.1 动态脚本](/chapter%2010#1021-动态脚本)
  - [10.2.2 动态样式](/chapter%2010#1022-动态样式)
  - [10.2.3 操作表格](/chapter%2010#1023-操作表格)
  - [10.2.4 使用NodeList](/chapter%2010#1024-使用NodeList)
</details>
